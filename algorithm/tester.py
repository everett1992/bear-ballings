...
User = collections.namedtuple("User", ["buckets", "classes", "credits", "id", "login", "name"])
...
for user in data["users"]:
    ...
    global_users.append(User(thisuserbin, [], thiscred, thisid, thislogin, thisname))
...
for p in classlist:
    ...
    outfile.write(str(global_users[student_n].login) + " ")
    outfile.write(str(global_users[student_n].name) + " ")
